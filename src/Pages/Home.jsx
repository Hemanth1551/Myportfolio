...
const TECH_STACK = ["JAVA","React", "Javascript", "Python", "PHP"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Hemanth1551" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/dommeti-hemanth-039092308" },
  { icon: Instagram, link: "https://www.instagram.com/hemanth_dommeti_" },
];
        ...
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            <div
              ...
              data-aos-delay="200"
            >
              <div className="space-y-4 sm:space-y-6" style={{ marginLeft: "50px" }}>
                <StatusBadge />
                <MainTitle />
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
AI & Full-Stack Developer | Python, Java, JavaScript, PHP | AI, Web Dev, Cloud | Built Health Assistant & Diabetes Predictor | Microsoft Azure | DSA with Java                </p>
